...
import 'package:paint_lite/models/drawing_mode.dart';
import 'package:paint_lite/models/sketch.dart';
          ...
          children: [
            ...
            Center(
              child: GestureDetector(
                onTap: () => _launchUrl('https://mrmorningstark.github.io/aboutUs/'),
                child: const Text(
                  'About this Project',
                  style: TextStyle(
                      fontWeight: FontWeight.w400, color: Colors.cyan),
                ),
              ),
            ),
          ],
